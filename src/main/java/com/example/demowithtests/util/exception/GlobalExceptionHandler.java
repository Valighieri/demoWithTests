...
//                        request.getDescription(false));
    ...
    public ResponseEntity<?> resourceNotExistException(ResourcesNotExistException ex,
                                                       WebRequest request){
        ErrorDetails errorDetails = new ErrorDetails(
                new Date(),
                "Database doesn't contain active users: " + ex.getMessage(),
    ...
    @ExceptionHandler(ResourceNotUpdateException.class)
    public ResponseEntity<MyGlobalExceptionHandler> handleUpdateException(){
        return new ResponseEntity<>(new MyGlobalExceptionHandler
                ("This user(s) can't be updated"), HttpStatus.NOT_FOUND);
    }
